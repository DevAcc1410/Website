        ...
        <div className="grid lg:grid-cols-2 items-center gap-20">
          ...
          >
            ...
            <p className="text-muted text-opacity-60 text-18 mb-8">
              From startups to established enterprises, we've helped brands across 
              various industries achieve their marketing goals and build lasting 
              connections with their audiences.
            </p>

            <table className="w-full sm:w-[90%]">
              <tbody>
                {portfolioData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="py-5">
                      <h4 className="text-white sm:text-24 text-20 ml-5 mb-2">
                        {item.title}
                      </h4>
                      <p className="text-muted text-opacity-60 text-16 ml-5">
                        {item.description}
                      </p>
                    </td>
                  </tr>
